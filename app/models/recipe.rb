class Recipe < ActiveRecord::Base
	...
	scope :ingredient, -> (array) { joins(:ingredients).where(ingredients: {name: array}).group("recipes.id").order(count: :desc) }
	...
	EXCLUSION = ["dairy", "eggs", "peanuts", "nuts", "soy", "gluten", "seafood", "vegetarian", "spicy"]
	...
	CATEGORY = ["Dips and Spreads", "Appetizers", "Snacks", "Main Dish", "Side Dish", "Desserts", "Everyday Cooking", "Kids", "Healthy", "Quick and Easy", "Cute and Fun"]
